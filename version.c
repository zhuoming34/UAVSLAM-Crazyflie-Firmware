...
const char * V_SLOCAL_REVISION="36";
const char * V_SREVISION="32dad2392d62";
const char * V_STAG="2020.04 +36";
...
const uint32_t V_REVISION_0=0x32dad239;
const uint16_t V_REVISION_1=0x2d62;
